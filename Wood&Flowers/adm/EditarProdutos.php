  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="scripts/editarprodutos.php" method="post">
          <?php
          if (isset($_GET['error'])) {
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    $sql = "SELECT idProduto,idEmpresa,idEstadoProduto,nomeProduto,precoProduto,descricao FROM produtos WHERE idProduto=$idProduto";
                    $result = mysqli_query($conn, $sql);
                    if (mysqli_num_rows($result) > 0) {
                      $row = mysqli_fetch_assoc($result);
                    ?>
                      <input hidden id="idProduto" name="idProduto" value="<?php echo $row['idProduto']; ?>">
                      <label for=" inputStatus">Empresa</label>
                      <select class="form-control custom-select" id="empresa" name="empresa">
                        <?php if ($row['idEmpresa'] == 1) { ?>
                          <option selected value="Wood_Flowers">Wood&Flowers</option>
                          <option value="Carpintaria">Carpintaria</option>
                        <?php } else if ($row['idEmpresa'] == 2) { ?>
                          <option selected value="Carpintaria">Carpintaria</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="nome" name="nome" class="form-control" value="<?php echo $row['nomeProduto'] ?>">
                  </div>
                  <div class=" form-group">
                    <label for="inputName">Preço</label>
                    <input type="text" id="preco" name="preco" class="form-control" value="<?php echo $row['precoProduto'] ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control custom-select" id="estado" name="estado">
                      <?php if ($row['idEstadoProduto'] == 1) { ?>
                        <option selected value="Existe">Existe</option>
                        <option value="NaoExiste">Não Existe</option>
                      <?php } else if ($row['idEstadoProduto'] == 2) { ?>
                        <option value="Existe">Existe</option>
                        <option selected value="NaoExiste">Não Existe</option>
                      <?php } ?>
                    </select>
                  </div>
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" name="editar-produto" class="btn btn-secondary">Guardar</button>
