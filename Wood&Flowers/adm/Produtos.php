            ...
            <div class="card-body">
              <table id="produtos" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT idProduto,idEmpresa,idEstadoProduto,nomeProduto,precoProduto,descricao FROM produtos";
                  $result = mysqli_query($conn, $sql);
                  if (mysqli_num_rows($result) > 0) {
                    $idx = 0;
                  ...
                  ?>
                      <tr>
                        <td><a name="idProduto" id="idProduto" href="./EditarProdutos.php?idProduto=<?php echo $row['idProduto'] ?>"><?php echo $row['idProduto']; ?></a></td>
                        <td><?php if ($row['idEmpresa'] == 1) {
                              echo "Wood&Flowers";
                            } else if ($row['idEmpresa'] == 2) {
                              echo "Carpintaria";
                            } ?></td>
                        <td><?php echo $row['nomeProduto']; ?></td>
                        <td><?php echo $row['precoProduto']; ?>€</td>
                        <td><?php echo $row['descricao']; ?></td>
                        <td><?php if ($row['idEstadoProduto'] == 1) {
                              echo "Existe";
                            } else if ($row['idEstadoProduto'] == 2) {
                              echo "Não Existe";
                            } ?></td>
                      </tr>
                  <?php
