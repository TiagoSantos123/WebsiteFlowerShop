  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="scripts/editarutilizador.php" method="post">
          <?php
          if (isset($_GET['error'])) {
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    $sql = "SELECT idUsers,idUtilizador,pNome,uNome,emailUsers FROM utilizadores WHERE idUsers=$idUtilizador";
                    $result = mysqli_query($conn, $sql);
                    if (mysqli_num_rows($result) > 0) {
                      $row = mysqli_fetch_assoc($result);
                    ?>
                      <input hidden id="idUsers" name="idUsers" value="<?php echo $row['idUsers']; ?>">
                      <label for=" inputStatus">Tipo</label>
                      <select class="form-control custom-select" id="tipo" name="tipo">
                        <?php if ($row['idUtilizador'] == 1) { ?>
                          <option selected value="Normal">Normal</option>
                          <option value="Admin">Admin</option>
                        <?php } else if ($row['idUtilizador'] == 2) { ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="pNome" name="pNome" class="form-control" value="<?php echo $row['pNome'] ?>">
                  </div>
                  <div class=" form-group">
                    <label for="inputName">Apelido</label>
                    <input type="text" id="uNome" name="uNome" class="form-control" value="<?php echo $row['uNome'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="inputName">Email</label>
                    <input type="text" id="email" name="email" class="form-control" value="<?php echo $row['emailUsers'] ?>">
                  </div>
                <?php
                    }
                ?>
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" name="editar-utilizador" class="btn btn-secondary">Guardar</button>
