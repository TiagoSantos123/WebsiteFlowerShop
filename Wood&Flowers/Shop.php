            ...
            <div class="mx-auto">
              <nav class="site-navigation position-relative text-left" role="navigation">
                <ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
                  ...
                  <li class="active"><a href="shop.php" class="nav-link text-left">Carpintaria</a></li>
              ...
              <div class="col-lg-4 mb-5 col-md-6">
                <form action="cart.php" action="post">
                  <div class="wine_v_1 text-center pb-4">
                    ...
                    <div>
                      <h3 class="heading mb-1" name="nomeProduto"><a href="#"><?php echo $row['nomeProduto']; ?></a></h3>
                      <span class="price" name="precoProduto"><?php echo $row['precoProduto'] . "€" ?><br> Sujeito a orçamento</span>
                    ...
                    <div class="wine-actions">
                      ...
                      <a href="cart.php?setCart&idProduto=<?php echo $row['idProduto']; ?>&nomeProduto=<?php echo $row['nomeProduto']; ?>&precoProduto=<?php echo $row['precoProduto'] ?>&quantidade=1" style="background-color:#86b300" class="btn btn-success" name="addCart"><span class="icon-shopping-bag mr-3"></span> Adicionar ao carrinho</a>
                    </div>
                  </div>
                </form>
